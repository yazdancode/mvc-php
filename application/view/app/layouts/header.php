        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo $this->url('home');?>">Home <span class="sr-only"></span></a>
                </li>
                <?php foreach ($categories as $category){?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $this->url('home/category/'.$category['id']);?>"><?php echo $category['title'];?></a>
                </li>
                <?php }?>
            </ul>
        </div>
